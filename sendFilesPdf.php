...
$date = mysqli_real_escape_string($con, (strip_tags($_GET["date"], ENT_QUOTES)));
$meses = array(
...
$queryAsociados = mysqli_query($con, "SELECT * FROM asociados WHERE estado='NO ENVIADO'");
...
while ($infoAsociados = mysqli_fetch_array($queryAsociados)) {
    ...
    try {
        ...
        $mail->addAddress($emailSmtp);  //Add a recipient
...
echo '  <div class="jumbotron alert-success text-center">
        ...
        <h1 class="display-4"><b>¡TODOS LOS ARCHIVOS HAN SIDO  ENVIADO CON ÉXITO!</b></h1>
        <p class="lead text-center"><b>El estado y fecha de envio se han actualizado con éxito.</b></p>
        <hr class="my-4">
