<div class="col col-lg-12 col-md-6 col-sm-12">
    <div class="card border-info mb-3 shadow rounded bg-transparent" style="max-width: 100%;">
        <div class="card-header text-center bg-info text-white">Asociados</div>
        <div class="card-body text-info text-center">
            <?php
            // Consulta MySQL para contar la cantidad de datos
            $sql = "SELECT COUNT(*) AS cantidad FROM asociados ";
            ...
            echo "<h1 class='card-title'><i class='fa-solid fa-users'></i> ".$cantidad."</h1>";
            ?>
         </div>
    </div>
</div>